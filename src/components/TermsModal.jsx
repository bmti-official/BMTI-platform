            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-gray-600 break-keep">
                  본 약관은 '자기점검 50분'(이하 "회사"라 합니다)이 운영하는 웹사이트에서 제공하는 BMTI 검사, 말랑 다이어리(하루 기록·월간 발견 리포트), 큐레이션(건강 관리 콘텐츠 제공), 예약(전문가 세션·클래스 예약, 준비 중) 등 서비스(이하 "서비스"라 합니다)를 이용함에 있어 회사와 이용자의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.
                </p>
              </div>
              ...
              <div className="bg-red-50 p-4 rounded-xl border border-red-100">
                ...
                <p className="text-red-700/90 break-keep space-y-2">
                  <span className="block">"회사"는 이용자의 BMTI 검사 결과와 하루 기록(기분·수면·불편 부위 등)을 바탕으로 몸 상태를 돌아볼 수 있는 발견 리포트와 건강 관리 큐레이션 콘텐츠를 제공하며, 향후 예약을 통한 전문가 세션·클래스를 제공할 예정입니다.</span>
              ...
              <div>
                ...
                <p className="text-gray-600 break-keep">
                  현재 제공 중인 서비스(BMTI 검사, 말랑 다이어리, 큐레이션)는 무료로 이용하실 수 있습니다.<br/>
                  향후 예약을 통한 전문가 세션·클래스 등 유료 서비스가 도입될 경우, 결제·청약철회·환불에 관한 사항은 「전자상거래 등에서의 소비자보호에 관한 법률」 및 회사가 해당 서비스 화면에서 별도로 안내하는 정책에 따릅니다.
                </p>
              </div>
          ...
          <section>
            ...
            <div className="space-y-4">
              <div>
                ...
                <ul className="list-disc pl-5 text-gray-600 space-y-1">
                  <li>서비스 제공: BMTI 검사 결과 분석, 말랑 다이어리 기록 저장 및 월간 발견 리포트 제공, 건강 관리 큐레이션 콘텐츠 제공</li>
                  <li>예약 서비스 안내: 전문가 세션·클래스 예약 기능 준비 및 안내(준비 중)</li>
