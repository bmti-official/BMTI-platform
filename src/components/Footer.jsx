...
const Footer = () => {
  ...
  return (
    <footer className="py-8 mt-8 border-t border-gray-100 fade-in px-4 md:px-6 w-full relative">
      <div className="max-w-6xl mx-auto flex flex-row items-start justify-between w-full">
        {/* Left: Business Info Accordion */}
        ...
        {/* Right: Links */}
        <div className="flex flex-row flex-wrap justify-end gap-1.5 md:gap-3 text-[10px] md:text-xs font-bold text-gray-500 flex-1">
      ...
      {/* Accordion Content */}
      {isInfoOpen && (
        <div className="max-w-6xl mx-auto mt-6 p-4 md:p-5 bg-gray-50 rounded-xl border border-gray-100 text-[10px] md:text-xs text-gray-500 leading-relaxed text-center md:text-left animate-fade-in-up">
