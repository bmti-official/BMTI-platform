...
export function Mallang({ v, size = 44, tapKey = 0, skinOverride }) {
  ...
  if (skinImages) {
    ...
    const filter = MALLANG_MOOD_FILTER_OVERRIDE[effectiveSkin]?.[v] || MALLANG_MOOD_FILTER[v] || "none";
    ...
    return (
      <span style={{ display: "flex", alignItems: "center", justifyContent: "center", width: size, height: size, margin: "0 auto", transform: `scale(${scale})`, transformOrigin: "50% 50%" }}>
