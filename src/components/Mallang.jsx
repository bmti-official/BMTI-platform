...
export function Mallang({ v, size = 44 }) {
  ...
  return (
    <svg viewBox="0 0 100 82" width={size} height={size * 0.82} style={{ display: "block", margin: "0 auto", overflow: "visible" }}>
      ...
      {v === 1 && <>
        <path d="M28 38 Q34 33 40 38" stroke={eye} strokeWidth="2.6" fill="none" strokeLinecap="round" />
        <path d="M60 38 Q66 33 72 38" stroke={eye} strokeWidth="2.6" fill="none" strokeLinecap="round" />
      ...
      {v === 2 && <>
        <path d="M28 40 Q34 36 40 40" stroke={eye} strokeWidth="2.6" fill="none" strokeLinecap="round" />
        <path d="M60 40 Q66 36 72 40" stroke={eye} strokeWidth="2.6" fill="none" strokeLinecap="round" />
        <line x1="43" y1="55" x2="57" y2="55" stroke={eye} strokeWidth="2.6" strokeLinecap="round" />
      </>}
      {v === 3 && <>
        <circle cx="35" cy="40" r="3.4" fill={eye} />
        <circle cx="65" cy="40" r="3.4" fill={eye} />
        <line x1="43" y1="55" x2="57" y2="55" stroke={eye} strokeWidth="2.6" strokeLinecap="round" />
      </>}
      {v === 4 && <>
        <circle cx="35" cy="39" r="3.4" fill={eye} />
        <circle cx="65" cy="39" r="3.4" fill={eye} />
        <path d="M42 52 Q50 60 58 52" stroke={eye} strokeWidth="2.6" fill="none" strokeLinecap="round" />
      </>}
      {v === 5 && <>
        <path d="M28 42 Q34 34 40 42" stroke={eye} strokeWidth="2.8" fill="none" strokeLinecap="round" />
        <path d="M60 42 Q66 34 72 42" stroke={eye} strokeWidth="2.8" fill="none" strokeLinecap="round" />
