...
export const QUESTIONS = [
  "스트레스를 받으면 밖으로 나가 몸이라도 움직여야 직성이 풀린다.",       // Q1 (A)
  "아무 소리도 안 들리는 고요한 공간에 있을 때 가장 평온하다.",             // Q2 (O)
  "가만히 누워만 있는 휴식은 오히려 몸을 더 찌뿌둥하게 만든다.",              // Q3 (A)
  "사람이 많고 복잡한 환경에 노출되면 에너지가 급격히 떨어진다.",             // Q4 (O)
  "땀을 가볍게라도 흘리고 났을 때 진짜 잘 쉬었다는 느낌이 든다.",             // Q5 (A)
  "어딘가 뻐근하면 딱 그 아픈 부위만 집중적으로 주무르게 된다.",              // Q6 (C)
  "거울을 볼 때 특정 부위보다 전신의 비율과 대칭을 먼저 살핀다.",             // Q7 (L)
  "특정 근육 딱 한 곳에만 힘을 집중하는 느낌을 비교적 잘 안다.",              // Q8 (C)
  "목이 아프면 골반이나 발목도 틀어졌을 것 같아 찝찝하고 신경 쓰인다.",         // Q9 (L)
  "뭉친 곳을 콕 집어 직접적으로 타격해 주는 직관적인 관리가 좋다.",           // Q10 (C)
  "새로운 물건을 사면 설명서를 읽기보다 일단 조작해 보며 익힌다.",            // Q11 (D)
  "누군가의 지시를 따를 때 \"이걸 왜 해야 하는지\" 납득하는 것이 중요하다.",  // Q12 (Q)
  "길고 복잡한 설명보다 내가 직접 한 번 부딪혀보는 것이 훨씬 빠르다.",        // Q13 (D)
  "행동으로 옮기기 전 머릿속으로 전체 과정을 미리 그려봐야 안심이 된다.",       // Q14 (Q)
  "시작부터 완벽할 필요 없이, 일단 하면서 감을 잡고 수정해 나가는 편이다.",   // Q15 (D)
  "위로의 말보다 구체적인 수치와 명확한 해결책을 제시받을 때 마음이 놓인다.",   // Q16 (Z)
  "결과를 평가받기 전, 내가 그동안 노력한 과정을 먼저 인정받고 싶다.",          // Q17 (M)
  "빙빙 돌리지 않고 팩트만 단호하게 말해주는 사람에게 더 큰 신뢰를 느낀다.",    // Q18 (Z)
  "아무리 맞는 말이라도 말투가 차가우면 마음의 문이 먼저 닫힌다.",            // Q19 (M)
  "누군가에게 조언을 구할 때, 다정한 공감보다 냉정하고 객관적인 평가를 원한다."  // Q20 (Z)
];
