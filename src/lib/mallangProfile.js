...
export const SORE_PARTS = ["머리", "목", "어깨", "팔꿈치", "손목", "팔", "등", "복부", "허리", "골반", "다리", "무릎", "발목", "기타"];
...
// 팔·다리처럼 길게 이어지는 부위는 몸 옆면에 세로 선을 그어 고르게 한다.
const L = (part, x, y, w, h) => ({ part, x, y, w, h, line: true });
...
export const HOTSPOTS = {
  front: [
    ...
    L("팔", 10, 33, 7, 29), L("팔", 83, 33, 7, 29),       // 양팔 바깥쪽 ㄷ자 범위 표시
    L("다리", 25, 62, 7, 31), L("다리", 68, 62, 7, 31),   // 양다리 바깥쪽 ㄷ자 범위 표시
  ],
  back: [
    Z("머리", 40, 5, 20, 13),
    ...
    L("팔", 10, 33, 7, 29), L("팔", 83, 33, 7, 29),
    L("다리", 25, 62, 7, 31), L("다리", 68, 62, 7, 31),
  ],
};
// 앞 ↔ 뒤 두 뷰만 전환
